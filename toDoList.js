...
for(let i = 0 ; i<todoList.length; i++){
    ...
    let html = 
        `<div class="todoContainerDiv"> 

        <div class="nameDiv">${name} </div>
            

            <div class="dueDiv">${dueDate}</div>  
...
let btnElement = document.querySelector('.js-btn-element');
let inputElemet = document.querySelector('.js-input-element');
